...
// 				    console.log(unit_price);
                ...
                // tr_html +='<td class="text-right">'+formatMoney(parseFloat(unit_price) * parseFloat(item_qty)-(parseFloat(pr_tax_val)))+'</td>'; //net unit price pr_tax_val
                ...
                if (site.settings.tax1 == 1) {
                    ...
                    // tr_html += '<td class="text-right"><input class="form-control input-sm text-right rproduct_tax" name="product_tax[]" type="hidden" id="product_tax_' + row_no + '" value="' + pr_tax.id + '"><span class="text-right sproduct_tax" id="sproduct_tax_' + row_no + '">' + (pr_tax_rate ? '(' + pr_tax_rate + ')tax' : '') + ' ' + formatMoney(pr_tax_val * item_qty) + '</span></td>';
                }
