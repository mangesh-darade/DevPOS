    ...
    $(document).ready(function () {
        ...
        var oTable = $('#PayRData').dataTable({
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                // nCells[8].innerHTML = currencyFormat(parseFloat(supercash));
            ...
            {column_number: 6, filter_default_label: "[<?= lang('Order_ref'); ?>]", filter_type: "text", data: []},
            ...
            <?php } ?>
            <?php if($pos_settings->supercash_amount == 0){ ?>
