                    ...
                    <table class="table table-striped table-bordered table-condensed table-hover dfTable reports-table">
                        <thead>
                            <tr>
                                ...
                                <th>Total Deposit Amount</th>
                                 <?php if ($this->pos_settings->supercash_amount==1){?><th>Super Cash</th> <?php }?>                    
                            ...
                            if(!empty($customers)) {
                                        ...
                                        {                                             
                                            ?>
                                               <tr>
                                                   ...
                                                   <?php if ($this->pos_settings->supercash_amount==1){?>
                                                                 <td class="text-right">Rs. <?= number_format($customer->supercash_amount, 2)?></td><?php
                                                    }
                                          ...
                                          <?php
                                                ...
                                                $supercash_amount +=$customer->supercash_amount;//supercash d
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <!-- supercash d -->
                                <?php if ($this->pos_settings->supercash_amount==1){?>  <th class="text-right">Rs. <?= number_format($supercash_amount,2)?></th> <?php }?> 
