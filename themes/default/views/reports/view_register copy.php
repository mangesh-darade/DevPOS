    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"
                id="myModalLabel"><?= lang('view_register') . ' (' . $this->sma->hrld($register_open_time ? $register_open_time : $this->session->userdata('register_open_time')) . ' - ' . $this->sma->hrld($register_close_time ? $register_close_time : date('Y-m-d H:i:s')) . ')'; ?></h4>
        </div>
...
<!--                    <td style="text-align:right;border-bottom: 1px solid #EEE;">
                ...
                <tr>
                 ...
                 <tr> <td style="border-bottom: 1px solid #DDD;"><h4><?= lang('Supercash'); ?>:</h4></td>
                      <td style="text-align:right;border-bottom: 1px solid #DDD;"><h4>
                           <span><?= $this->sma->formatMoney($supercash->paid ? $supercash->paid : '0.00') ?></span>
                       <!--<span><?= $this->sma->formatMoney($supercash->paid ? $supercash->paid : '0.00') . ' (' . $this->sma->formatMoney($supercash->total ? $supercash->total : '0.00') . ')'; ?></span>--></h4>
                      </td>
                </tr>
                  <?php  }?>   
                  <tr>
...
<!--                    <td style="text-align:right;border-bottom: 1px solid #DDD;">
                ...
                <tr>
                    ...
                    <?php 
                     ...
                     $total_cash_amount = $cashsales->paid ? (($cashsales->paid + ($this->session->userdata('cash_in_hand'))) + ($refunds->returned ? $refunds->returned : 0) - $expense) : $this->session->userdata('cash_in_hand')-$expense; 
                      ?>
                            <span><strong><?php echo $this->sma->formatMoney($total_cash_amount);?></strong></span>
                            <!-- <span><strong><?php echo $this->sma->formatMoney($total_cash_amount);print_r($cashsales); echo "<br>".$this->session->userdata('cash_in_hand'); echo "<br>".$refunds->returned; echo "<br>".$expense;?></strong></span> -->
                        </h4></td>
                </tr>
        ...
        <div class="modal-footer no-print ">
            <!-- <?= form_submit('close_register', lang('close_register1'), 'class="btn btn-primary d-none"'); ?> -->
        </div>
    </div>
    <?= form_close(); ?>
</div>
