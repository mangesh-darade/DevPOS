...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#registerTable').dataTable({
            ...
            "aoColumns": [{"mRender": fld}, {"mRender": fld}, null, {"mRender": currencyFormat}, {"mRender": total_sub}, {"mRender": total_sub}, {"mRender": total_cash}, {"bSortable": false},{"bVisible": false},{"bVisible": false},null]
            ...
            {column_number: 8, filter_default_label: "[<?=lang('rid');?>]", filter_type: "text", data: []},
            {column_number: 9, filter_default_label: "[<?=lang('uid');?>]", filter_type: "text", data: []},
