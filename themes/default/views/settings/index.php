...
?>
                           ...
                           <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="deposit_discount"><?= lang("SuperCash Discount"); ?> (%) <img src="<?= $assets ?>images/new.gif" height="25px" alt="new" /> </label>
                                    <div class="controls">
...
name="deposit_discount" class="form-control" placeholder="Deposit Discoutn in %" />
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="deposit_cash_limit"><?= lang("Minimum SuperCash Limit"); ?> (%) <img src="<?= $assets ?>images/new.gif" height="25px" alt="new" /> </label>
                                    <div class="controls">
...
<?= form_input('sms_promotional_header', $Settings->sms_promotional_header, 'class="form-control tip " id="sms_promotional_header" maxlength="10"'); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="controls">                                   
<?= form_input('sms_brand_name', $Settings->sms_brand_name, 'class="form-control tip " id="sms_brand_name" maxlength="10"'); ?>
                                    </div>
                                </div>
                            </div>
