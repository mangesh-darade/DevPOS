                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="checkbox" value="1" class="checkbox" id="reports-transfer_item"
                                                           name="reports-transfer_item" <?php echo $p->{'reports-transfer_item'} ? "checked" : ''; ?>>
                                                    <label for="reports-transfer_item" class="padding05"><?= lang('Transfer_Report') ?></label>
                                                </div>
