...
<script>
    $(document).ready(function () {
        $('#CategoryTable').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getDepositTypes') ?>',
...
<?= form_open('system_settings/deposit_type_actions', 'id="action-form"') ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo site_url('system_settings/add_deposit_type'); ?>" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus"></i> <?= lang('Add_Deposit_Types') ?>
                            </a>
                        </li>
                        <!-- <li>
                    ...
                    <table id="CategoryTable" class="table table-bordered table-hover table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><?= lang("Default_Deposit_Amt"); ?></th>
                                <th><?= lang("Supercash_Min_Amt"); ?></th>
                                <th><?= lang("Supercash(Amt)"); ?></th>
                                <th><?= lang("Supercash(%)"); ?></th>
                                <th><?= lang("Refundable"); ?></th>
                                <th><?= lang("start_Date"); ?></th>
                                <th><?= lang("End_Date"); ?></th>
                                <th><?= lang("Lock_in_Days"); ?></th>
