            ...
            <div class="col-lg-12">
                <fieldset class="scheduler-border">
                    ...
                    <div class="row form-group all">
                        ...
                        <!-- <div class="col-sm-6 col-xs-12 form-group"> 
                            <div class="col-sm-12 col-xs-12">
                                <input type="checkbox" <?php echo!empty($printer_option->show_due_amount) ? 'Checked' : ''; ?>  value="1" name="show_due_amount">
                                <b style="text-transform: capitalize;"> <?= lang("Show Due Amount "); ?> <img src="<?= base_url('themes/default/assets/images/new.gif')?>" height="30px" alt="new"></b>
                            </div>
                        </div>                              -->
                    </div>   
