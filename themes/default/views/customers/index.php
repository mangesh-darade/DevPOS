    ...
    $(document).ready(function () {
        var cTable = $('#CusData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null, null, null, null, null,{"mRender": currencyFormat},  null,null, null, <?php if ($this->pos_settings->supercash_amount==1){?> {"mRender": currencyFormat},{"mRender": currencyFormat}, <?php }?> {"mRender": currencyFormat}, {"bSortable": false}]
        }).dtFilter([
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                         ...
                         <!-- create bulk deposite   -->
                         <li>
                            <a href="<?= site_url('customers/getBulkDeposit'); ?>" data-toggle="modal" data-target="#myModal">
                ...
                <div class="table-responsive">
                    <table id="CusData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="primary">
                            ...
                            <th><?= lang("Card No."); ?></th>
                            <th><?= lang("Room No."); ?></th>
                            <?php if ($this->pos_settings->supercash_amount==1){?><th>Supercash</th><th>Total_balance</th> <?php }?>  
                            <!-- <th><?= lang("Supercash"); ?></th> -->
                        ...
                        <tr class="active">
                           ...
                           <th></th><th></th>
                           <?php if ($this->pos_settings->supercash_amount==1){?><th></th><th></th><?php }?> 
