        ...
        <div class="modal-body">
            <div class="table-responsive">
                ...
                <table class="table table-striped table-bordered" style="margin-bottom:0;">
                    ...
                    <tr>
                        <td><strong><?= lang("Supercash"); ?></strong></td>
                        <td><?= $this->sma->formatMoney($customer->supercash_amount); ?></strong></td>
                    </tr>
                    <tr>
                        <td><strong><?= lang("Total Balance"); ?></strong></td>
                        <td><?= $this->sma->formatMoney($customer->deposit_amount + $customer->supercash_amount ); ?></strong></td>
                    </tr>
                    <?php } ?>
                    <tr>
