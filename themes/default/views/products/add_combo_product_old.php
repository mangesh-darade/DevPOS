                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group all">
                                    ...
                                    echo form_dropdown('division', $br, (isset($_POST['division']) ? $_POST['division'] : ($product ? $product->division : $_SESSION['division'])), 'class="form-control select2" id="division" placeholder="' . lang("select") . " " . lang("division") . '" style="width:100%"')
                                    ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group all" >
                                        ...
                                        echo form_dropdown('tax_rate', $tx, (isset($_POST['tax_rate']) ? $_POST['tax_rate'] : ($product ? $product->tax_rate : $Settings->default_tax_rate)), 'class="form-control select2" id="tax_rate" placeholder="' . lang("select") . ' ' . lang("product_tax") . '" style="width:100%"')
                                        ?>
                                    </div>
                                </div>
                                <div class="col-md-4">
                            ...
                            <?php if ($Settings->pos_type == 'restaurant') { ?>
                                <?php if ($Settings->product_external_platform == '1') { ?>
                                    ...
                                    <div class="form-group all">
                                        ...
                                        <select class="form-control select2" name="up_items" id="urbanpiperitem">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <select class="form-control select2" name="up_food_type" id="up_food_type">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <select class="form-control select2" name="available" id="available">
                                                            <option value="1">Yes</option>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <select class="form-control select2" name="sold_at_store" id="sold_at_store">
                                                            <option value="1">Yes</option>
                                                            <option value="0">No</option>
                                                        </select>    
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <select class="form-control select2" name="recommended" id="recommended">
                                                            <option value="1">Yes</option>
                                                            <option value="0">No</option>
                                                        </select>    
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                   <div class="form-group ">
                                                        ...
                                                        <select class="form-control select2" name="manage_stock" id="manage_stock">
                                                            <option value="1">Yes</option>
                                                            <option value="0">No</option>
                                                        </select>    
                                                    </div>
                                            ...
                                            <div class="row">
                                                 ...
                                                 <div class="col-sm-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <select class="form-control select2" name="default_tag" id="default_tag" data-role="tagsinput">
