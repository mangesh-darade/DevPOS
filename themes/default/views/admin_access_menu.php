...
<li class="mm_transfers">
    ...
    <ul>
        ...
        <!-- <li id="transfers_add_request">
            <a class="submenu"
               href="<?= site_url('transfers/transferReport'); ?>">
                <i class="fa fa-plus-circle"></i><span
                    class="text"> <?= lang('Transfer Report'); ?> <img src="<?= $assets ?>images/new.gif" height="30px" alt="new" /></span>
            </a>
        </li> -->
    </ul>
</li>
...
<?php if($Settings->active_urbanpiper) { ?>
    ...
    <li class="mm_system_settings <?= strtolower($this->router->fetch_method()) != 'settings' ? '' : 'mm_pos' ?>">
        ...
        <ul>
            ...
            <li id="system_settings_deposit_type">
                <a href="<?= site_url('system_settings/deposit_type') ?>">
                    <i class="fa fa-cog"></i><span class="text"> <?= lang('Deposit_Type'); ?></span> <img src="<?= $assets ?>images/new.gif" height="30px" alt="new" />
                </a>
            </li>
    ...
    <ul>
        ...
        <li id="reports_get_product_wise_sales">
            <a href="<?= site_url('reports/Product_wise_Sale_Report') ?>">
                <i class="fa fa-thumbs-up"></i><span
                    class="text"> <?= lang('Product_Wise_Sale_Report'); ?></span> <img src="<?= $assets ?>images/new.gif" height="30px" alt="new" />
            </a>
        </li>
        <?php if (POS) { ?>
