...
<?php if ($GP['reports-quantity_alerts'] || $GP['reports-transfer_item'] || $GP['reports-expiry_alerts'] || $GP['reports-products'] || $GP['reports-monthly_sales'] || $GP['reports-sales'] || $GP['reports-payments'] || $GP['reports-purchases'] || $GP['reports-customers'] || $GP['reports-suppliers'] || $GP['reports-expenses'] || $GP['reports-warehouse_sales_report'] || $GP['reports-gst_reports']) { ?>
    <li class="mm_reports">
        <a class="dropmenu" href="#">
