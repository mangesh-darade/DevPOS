    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="modal-title" id="payModalLabel">
                    <?= lang('finalize_sale'); ?>
                </h2>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="container text-danger" id="showamtbalance" style="display:none">
                            ...
                            <?php  if($pos_settings->supercash_amount == 1) { ?>
                                <strong id="showsupercash" ></strong><br />
                                <strong id="showtotalamount"></strong><br />
                            <?php } ?>
                    ...
                    <div class="row ">
                        <div class="col-md-6 col-sm-12">
                            <div class="col-md-6 col-sm-3" id="verticalbtns" style="margin-top: 15px;">
                                <div class="class-title" style="font-weight: bold;">
                                    <?= lang('quick_cash'); ?>
                                </div>
                                <div class="btn-group btn-group-vertical">
                                    <button type="button" class="btn btn-lg btn-info quick-cash" id="quick-payable"><i
                                            class="fa fa-inr" aria-hidden="true"></i> 0.00 </button>
                                    <?php
                                            ...
                                            ?>
                                    <button type="button" class="btn btn-lg btn-danger" id="clear-cash-notes">
                                        <?= lang('clear'); ?>
                                    </button>
                                </div>
                            </div>
                                                ...
                                                <div class="payment">
                                                        ...
                                                        <div class="col-sm-6 col-xs-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="paid_by[]" id="paid_by_1"
                                                                    ...
                                                                    <!-- Supercash -->
                                                                    <?php echo (isset($pos_settings->supercash_amount) && $pos_settings->supercash_amount == '1') ?  ' <option value="supercash">Supercash</option>' : ''; ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            ...
                                                            <!-- Show Supercash Balance on finalize screen -->
                                                            <?php  if($pos_settings->supercash_amount == 1) ?>
                                                            <?php { ?>
                                                            <div class="form-group sc_1" style="display:none;">
                                                                <?= lang("Supercash Balance"); ?>
                                                                <div id="supercashdetails_1"></div>
                                                                <div id="errorsupercash_1"></div>
                                                            </div>
                                                        </div>
                                                        <?php } ?>
                                                        ...
                                                        <div class="display pother_1" style="display:none;">
                                                            ...
                                                            <div class="form-group" id="note">
                                                                <input name="other_tran_mode"
                                                                    placeholder="Transaction Mode" type="text"
                                                                    id="other_tran_mode_1"
                                                                    class="form-control kb-text ui-keyboard-input ui-widget-content ui-corner-all ui-keyboard-autoaccepted"
                                                                    maxlength="55" />
                                                            </div>
                                                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6 text-center mobcard card-div">
                            <div class="row card-box ps-scrollbar-y">
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    <div class="radio-div">
                                        ...
                                        <label for="checkbox1" class="payment-method"><span
                                                class="paddingTop whitebgredB">Cash</span></label>
                                        <span class="whitebgredB payment-icon">
                                            <img class="icon_image_option" src="<?= $assets ?>pos/images/cashh.png"
                                                alt="" class="icon_image_option2"></span></label>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    <div class="radio-div">
                                        ...
                                        <label for="checkbox2" class="payment-method"><span
                                                class="paddingTop whitebgredB">Cheque</span></label>
                                        <span class="payment-icon whitebgredB"><img
                                                src="<?= $assets ?>pos/images/cheque.jpg" alt=""
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    <div class="radio-div">
                                        ...
                                        <label for="checkbox3" class="payment-method"><span
                                                class="paddingTop whitebgredB">Deposit</span></label>
                                        <span class="payment-icon whitebgredB"> <img
                                                src="<?= $assets ?>pos/images/Deposit.png" alt=""
                                                class="icon_image_option"></span>
                                    </div>
                                </div>
                                <!-- supercash button on Finalize Screen -->
                                <?php  if($pos_settings->supercash_amount == '1'): ?>
                               
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    <div class="radio-div">
                                        <input type="radio" id="checkbox_5" class="card custom_payment_icon"
                                            name="colorRadio" value="supercash">
                                        <label for="checkbox_5" class="payment-method"><span
                                                class="paddingTop whitebgredB">Supercash</span></label>
                                        <span class="payment-icon whitebgredB"> <img
                                                src="<?= $assets ?>pos/images/supercash.gif" alt=""
                                                class="icon_image_option"></span>
                                    </div>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    <div class="radio-div">
                                        ...
                                        <label for="checkbox18" class="payment-method"><span
                                                class="paddingTop whitebgredB">Award Point</span></label>
                                        <span class="payment-icon whitebgredB"> <img
                                                src="<?= $assets ?>pos/images/Deposit.png" alt=""
                                                class="icon_image_option"></span>
                                    </div>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    <div class="radio-div">
                                        ...
                                        <label for="checkbox4" class="payment-method"><span
                                                class="paddingTop whitebgredB">Other</span></label>
                                        <span class="payment-icon whitebgredB"><img
                                                src="<?= $assets ?>pos/images/other.png" alt=""
                                                class="icon_image_option"></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    <div class="radio-div">
                                        ...
                                        <label for="checkbox5" class="payment-method"><span
                                                class="paddingTop orangebg">Gift Card</span></label>
                                        <span class="payment-icon orangebg"><img
                                                src="<?= $assets ?>pos/images/gift-card1.jpg" alt=""
                                                class="icon_image_option"> </span></label>
                                    </div>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    <div class="radio-div">
                                        ...
                                        <label for="checkbox6" class="payment-method"><span
                                                class="paddingTop orangebg">NEFT</span></label>
                                        <span class="payment-icon orangebg"><img src="<?= $assets ?>pos/images/neft.png"
                                                alt="" class="icon_image_option2"></span>
                                    </div>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    <div class="radio-div">
                                        ...
                                        <span class="payment-icon whitebgblueB"><img
                                                src="<?= $assets ?>pos/images/debit.png" alt="debit"
                                                class="icon_image_option"></span>
                                    </div>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    <div class="radio-div">
                                        ...
                                        <span class="payment-icon whitebgblueB"><img
                                                src="<?= $assets ?>pos/images/creaditcard.jpg" alt="creaditcard"
                                                class="icon_image_option"></span>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    <div class="radio-div">
                                        ...
                                        <span class="payment-icon whitebgblueB">
                                            <img src="<?= $assets ?>pos/images/paysweef.jpg" class="icon_image_option"
                                                alt="credit-card">
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    <div class="radio-div">
                                        ...
                                        <span class="payment-icon whitebgblueB">
                                         ...
                                         <?php if($pos_settings->paytm_opt== '1'): ?>
                                            ...
                                            <div class="radio-div">
                                                ...
                                                <span class="payment-icon whitebgblueB">
                                                    <img src="<?= $assets ?>pos/images/patm.png"
                                                        class="icon_image_option" alt="credit-card""></span>
                                                </div>
                                            </div>
                                         <?php endif; ?>                                        
                                        ...
                                        <?php if($pos_settings->google_pay == '1'): ?>
                                            <div class=" col-md-3 col-sm-6 col-xs-6">
                                                    <div class="radio-div">
                                                        <input id="checkbox10" title="Google pay" type="radio"
                                                            class="card custom_payment_icon" name="colorRadio"
                                                            value="Googlepay">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                <div class="radio-div">
                                                    <input id="checkbox11" title="Swiggy" type="radio"
                                                        class="card custom_payment_icon" name="colorRadio"
                                                        value="swiggy">
                                                    <label for="checkbox11" class="payment-method"><span
                                                            class="paddingTop whitebgblueB">Swiggy</span></label>
                                                    <span class="payment-icon whitebgblueB">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                <div class="radio-div">
                                                    <input id="checkbox12" title="Zomato" type="radio"
                                                        class="card custom_payment_icon" name="colorRadio"
                                                        value="zomato">
                                                    <label for="checkbox12" class="payment-method"><span
                                                            class="paddingTop whitebgblueB">zomato</span></label>
                                                    <span class="payment-icon whitebgblueB">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                <div class="radio-div">
                                                    ...
                                                    <label for="checkbox13" class="payment-method"><span
                                                            class="paddingTop whitebgblueB">ubereats</span></label>
                                                    <span class="payment-icon whitebgblueB">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                <div class="radio-div">
                                                    ...
                                                    <label for="checkbox14" class="payment-method"><span
                                                            class="paddingTop whitebgblueB">magicpin</span></label>
                                                    <span class="payment-icon whitebgblueB">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                <div class="radio-div">
                                                    <input id="checkbox14" title="Debit Card" type="radio"
                                                        ...
                                                        value="complimentry">
                                                    <label for="checkbox14" class="payment-method"><span
                                                            class="paddingTop whitebgblueB">Complimentry</span></label>
                                                    <span class="payment-icon whitebgblueB">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                <div class="radio-div">
                                                    ...
                                                    <label for="checkbox16" class="payment-method"><span
                                                            class="paddingTop whitebgblueB">UPI & QR CODE</span></label>
                                                    <span class="payment-icon whitebgblueB">
                                                        <img src="<?= $assets ?>pos/images/credit-card.jpg"
                                                            class="icon_image_option2" alt="credit-card">
                                                    </span>
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                <div class="radio-div">
                                                    ...
                                                    <label for="checkbox15" class="payment-method"><span
                                                            class="paddingTop whitebgredB">PayPal</span></label>
                                                    <span class="payment-icon whitebgredB"><img
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                <div class="radio-div">
                                                    ...
                                                    <label for="checkbox16" class="payment-method"><span
                                                            class="paddingTop orangebg">Stripe</span></label>
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                <div class="radio-div">
                                                    ...
                                                    <label for="checkbox17" class="payment-method"><span
                                                            class="paddingTop orangebg">Authorize</span></label>
                                                    <span class="payment-icon orangebg"><img
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                <div class="radio-div">
                                                    ...
                                                    <label for="checkbox18" class="payment-method"><span
                                                            class="paddingTop whitebg">Instamojo</span></label>
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                <div class="radio-div">
                                                    ...
                                                    <label for="checkbox19" class="payment-method"><span
                                                            class="paddingTop whitebgredB">CCavenue</span></label>
                                                    <span class="payment-icon whitebgredB"><img
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-6" id="paynear_btn_holder">
                                                <div class="radio-div">
                                                    <input type="radio" class="card custom_payment_icon"
                                                        name="colorRadio" id="paynear_btn" value="paynear">
                                                    <label for="paynear_btn" class="payment-method"><span
                                                            class="paddingTop whitebgredB">Paynear</span></label>
                                                    <span class="payment-icon whitebgredB"><img
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-6" id="payumoney_btn_holder">
                                                <div class="radio-div">
                                                    <input type="radio" class="card custom_payment_icon"
                                                        name="colorRadio" id="payumoney_btn" value="payumoney">
                                                    <label for="payumoney_btn" class="payment-method"><span
                                                            class="paddingTop whitebgredB">Payumoney</span></label>
                                                    <span class="payment-icon whitebgredB"><img
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                <div class="radio-div">
                                                    ...
                                                    <label for="checkbox21" class="payment-method"><span
                                                            class="paddingTop whitebgredB">Razorpay</span></label>
                                                    <span class="payment-icon whitebgredB"> <img
                    ...
                    <div class="modal-footer">
                        <div class="btn-group col-sm-12 marginleft1 checkoutmodalbtn">
                            <button class="col-5 col-xs-4 btn btn-primary cmdnotprint marginLR10 final-submit-btn"
                                name="cmd" id="submit-sale"><strong>Quick
                                    <?= lang('submit'); ?>
                                </strong> <img src="<?= $assets ?>pos/images/submit.png" alt="submit"></button>
                            <button
                                class="col-5 col-xs-4 btn btn-info cmdprint marginLR10 borderradius padding10 final-submit-btn"
                                name="cmdprint" id="submit-sale"><strong>
                                    <?= lang('submit'); ?> & Print
                                </strong> <img src="<?= $assets ?>pos/images/print.png" alt="submit"></button>
                            <button
                                class="col-5 col-xs-4 btn btn-success splitpay marginLR10 borderradius padding10 final-submit-btn"
                                name="splitpay" id="splitpay" onclick="split_order_pay()"><strong>Split Pay</strong>
                                <img src="<?= $assets ?>pos/images/split-pay.png" alt="submit"></button>
                            <button
                                class="col-5 col-xs-4 btn btn-danger marginLR10 borderradius padding10 splitcheck final-submit-btn"
                                type="button" onclick="split_order();"><strong>Split Check</strong> <img
                                    src="<?= $assets ?>pos/images/split-check.png" alt="submit"></button>
                            <button class="col-5 col-xs-4 btn cmdprint1 newblue marginLR10 padding10 final-submit-btn"
                                name="cmdprint1" id="submit-sale"><strong>Other</strong> <img
                                    src="<?= $assets ?>pos/images/check.png" alt="submit"></button>
