...
//                                      
                   ...
                   ?>  
                    ...
                    if ($payments) {
                        ...
                        foreach ($payments as $payment) {
                           // sun pdf view page
                            ...
                            if ($payment->paid_by == 'cash' || $payment->paid_by == 'deposit' || $payment->paid_by == 'Due Payment' ||$payment->paid_by == 'supercash') {
                                ...
                                if ($payments[count($payments) - 1]->paid_by == 'cash') {
                                 ...
                                 //supercash
                                if($payment->paid_by == 'supercash' && $customer->deposit_amount > 0){
                    ...
                    ?>
                        <?=
                        '<p class="text-center" style="margin-bottom:0px;">' . lang('total') . ' ' . lang('due_amount') . ':&nbsp;' . $this->sma->formatMoney( $dueAmounts).'</p>' 
                        ?>
                    <?php
