...
//                                            pass_variant= passvariant ;  
                               ...
                               // var checkdesable = 'FALSE';  //(result[i].item.quantity<=0)?'TRUE':'FALSE';
                                ...
                                htmlset+='<input name="product_option[]" disabled="ture" id="product_option_'+result[i].item.id+''+variant_id+'"  type="hidden" class="roption allcheck" value="'+result[i].item.varentid+'">   <i class="pull-right fa fa-edit tip tointer " onclick="edit_row(&#34;'+result[i].item.id+''+variant_id+'&#34;)" title="Edit" style="cursor:pointer;"></i></td>';
                                 ...
                                 htmlset+='<input name="taxType[]" disable="true" id="tax_type_'+result[i].item.id+''+variant_id+'" type="hidden" value="'+result[i].item.tax_type+'" >'; 
                                htmlset+='<input name="taxMethod[]" disable="true" id="tax_method_'+result[i].item.id+''+variant_id+'" type="hidden" value="'+result[i].item.tax_method+'" >'; 
                                htmlset+='<input name="taxRate[]" disable="true" id="tax_rate_'+result[i].item.id+''+variant_id+'" type="hidden" value="'+result[i].item.rate+'" >'; 
