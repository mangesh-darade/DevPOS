                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group" style="margin-bottom:5px;">
                                <?php $ShippingReadonly = '';
                                if (!$Admin) {
                                    $ShippingReadonly = 'readonly';
                                } ?>
                                        ...
                                        <table id="toTable"
                                            ...
                                            <tr>
                                             <th class="col-md-4"><?= lang("product_name") . " (" . $this->lang->line("product_code") . ")"; ?></th> 
                                                <?php if ($Settings->batch_purchese_setting) { ?>
                                             ...
                                             <th class="col-md-1"><?= lang("Stock ") ?><span id="stock_2"></span></th> 
                                              <?php
                                                ...
                                                <th class="col-md-1"><?= lang("net_unit_cost"); ?></th>
                                                <!-- 2/04/19 -->
<?php if ($transfer->status == 'request' || $transfer->status == 'partial' || $transfer->status == 'partial_completed' || $transfer->status == 'sent_balance' || $transfer->status == 'sent') { ?>
                                                         <th class="col-md-1 extracloumn"><?= lang("Request Quantity"); ?></th>
                                                         <th class="col-md-1 extracloumn"><?= lang("Sent Quantity"); ?></th>
                                                <?php } ?>
                                                <th class="col-md-1">
                                                        <?php
                                                        if ($transfer->status == 'partial_completed' || $transfer->status == 'partial') {
