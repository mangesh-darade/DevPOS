...
// sun
    ...
    function getRrgisterlogs($pdf = NULL, $xls = NULL, $img = NULL) {
        ...
        if ($pdf || $xls || $img) {
            ...
            $this->datatables->select("date, closed_at, CONCAT(" . $this->db->dbprefix('users') . ".first_name, ' ', " . $this->db->dbprefix('users') . ".last_name, '<br>', " . $this->db->dbprefix('users') . ".email) as user, cash_in_hand, CONCAT(total_cc_slips, ' (', total_cc_slips_submitted, ')'), CONCAT(total_cheques, ' (', total_cheques_submitted, ')'), CONCAT(total_cash, ' (', total_cash_submitted, ')'), note,". $this->db->dbprefix('pos_register') .".id as rid, ". $this->db->dbprefix('pos_register') .".user_id as uid", FALSE)->from("pos_register")->join('users', 'users.id=pos_register.user_id', 'left');
            ...
            $view_link = '<a href="' . site_url('reports/view_register/$1/$2') . '" data-target="#myModal" data-toggle="modal"><span class="label label-primary"><i class="fa fa-eye" aria-hidden="true"></i> View Register</span></a>';
            $this->datatables->add_column("Actions", $view_link,'rid,uid');
            echo $this->datatables->generate();
        }
    }
    public function view_register($rid= null, $user_id = null) {
        $this->sma->checkPermissions('index');

            if ($this->Owner || $this->Admin) {
               

                $user_register = $user_id ? $this->pos_model->getRegisterData($rid, $user_id) : null;
                $register_open_time = $user_register ? $user_register->date : null;
                $register_close_time = $user_register ? $user_register->closed_at : null;
                ...
                $this->data['register_close_time'] = $user_register ? $register_close_time : null;
            } else {
                ...
                $this->data['register_close_time'] = null;
            }
            $this->data['error'] = (validation_errors() ? validation_errors() : $this->session->flashdata('error'));

            $this->data['ccsales'] = $this->pos_model->getClosedRegisterCCSales($register_open_time,$register_close_time,$user_id);
            $this->data['cashsales'] = $this->pos_model->getClosedRegisterCashSales($register_open_time,$register_close_time,$user_id);
            $this->data['chsales'] = $this->pos_model->getClosedRegisterChSales($register_open_time,$register_close_time,$user_id);

            $this->data['gcsales'] = $this->pos_model->getClosedRegisterGCSales($register_open_time,$register_close_time,$user_id);
            $this->data['pppsales'] = $this->pos_model->getClosedRegisterPPPSales($register_open_time,$register_close_time, $user_id);
            $this->data['supercash'] = $this->pos_model->getClosedSupercashRegister($register_open_time,$register_close_time, $user_id);
            $this->data['depositsales'] = $this->pos_model->getClosedDepositRegister($register_open_time,$register_close_time, $user_id);
            /* --- 13-03-19 --- */
            $this->data['othersales'] = $this->pos_model->getClosedRegisterPaymentSales($register_open_time,$register_close_time, $user_id, 'other');

            $this->data['dcsales'] = $this->pos_model->getClosedRegisterPaymentSales($register_open_time,$register_close_time,$user_id, 'DC');

            $this->data['neftsales'] = $this->pos_model->getClosedRegisterPaymentSales($register_open_time,$register_close_time, $user_id, 'NEFT');
            $this->data['paytmsales'] = $this->pos_model->getClosedRegisterPaymentSales($register_open_time,$register_close_time, $user_id, 'PAYTM');
            $this->data['googlepaysales'] = $this->pos_model->getClosedRegisterPaymentSales($register_open_time,$register_close_time, $user_id, 'Googlepay');
            $this->data['swiggysales'] = $this->pos_model->getClosedRegisterPaymentSales($register_open_time,$register_close_time, $user_id, 'swiggy');
            $this->data['zomatosales'] = $this->pos_model->getClosedRegisterPaymentSales($register_open_time,$register_close_time, $user_id, 'zomato');
            $this->data['ubereatssales'] = $this->pos_model->getClosedRegisterPaymentSales($register_open_time,$register_close_time, $user_id, 'ubereats');
            $this->data['complimentrysales'] = $this->pos_model->getClosedRegisterPaymentSales($register_open_time,$register_close_time, $user_id, 'complimentry');
            $this->data['upiqrcode'] = $this->pos_model->getClosedRegisterPaymentSales($register_open_time,$register_close_time, $user_id, 'UPI_QRCODE');

            /* --- end 13-03-19  -- */
            $this->data['stripesales'] = $this->pos_model->getClosedRegisterStripeSales($register_open_time,$register_close_time, $user_id);
            $this->data['authorizesales'] = $this->pos_model->getClosedRegisterAuthorizeSales($register_open_time,$register_close_time,$user_id);
            $this->data['totalsales'] = $this->pos_model->getClosedRegisterSales($register_open_time,$register_close_time,$user_id);
            $this->data['duesales'] = $this->pos_model->getCloseddueAmt($register_open_time,$register_close_time,$user_id); //18-03-19
            $this->data['duepartial'] = $this->pos_model->getClosedpartialAmt($register_open_time,$register_close_time,$user_id); //20-03-19
            $this->data['refunds'] = $this->pos_model->getClosedRegisterRefunds($register_open_time,$register_close_time,$user_id);
            
            $this->data['cashrefunds'] = $this->pos_model->getClosedRegisterCashRefunds($register_open_time,$register_close_time,$user_id);
            $this->data['expenses'] = $this->pos_model->getClosedRegisterExpenses($register_open_time,$register_close_time, $user_id);
            $this->data['users'] = $this->pos_model->getUsers($user_id);
            $this->data['suspended_bills'] = $this->pos_model->getSuspendedsales($user_id);
            $this->data['user_id'] = $user_id;
            $this->data['modal_js'] = $this->site->modal_js();

            $this->data['deposit_received'] = $this->pos_model->getClosedRegisterDeposit($register_open_time,$register_close_time, $user_id);

            $this->load->view($this->theme . 'reports/view_register', $this->data);
                ...
                foreach ($transactionData as $rowdata) {
                   // my code
                    if ($rowdata['paid_by']) {
                        ...
                        $this->excel->getActiveSheet()->SetCellValue('C' . $row, ' Deposit Credited by '.strtoupper($rowdata['paid_by']));
                    ...
                    if ($rowdata['amount'] && $rowdata['super_cash'] > 0) {
                        ...
                        $this->excel->getActiveSheet()->SetCellValue('C' . $row, ' SuperCash Credited by '.strtoupper($rowdata['paid_by']));
                        $this->excel->getActiveSheet()->SetCellValue('D' . $row, number_format(0,2));
                        $this->excel->getActiveSheet()->SetCellValue('E' . $row, number_format($credit, 2));
                        $this->excel->getActiveSheet()->SetCellValue('F' . $row, number_format($Totalbalance, 2));
                        $row ++;
...
//                $this->excel->getActiveSheet()->getStyle("C" . $row . ":E" . $row)->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border::BORDER_MEDIUM);
            ...
            foreach ($transactionData as $rowdata) {
                ...
                if ($rowdata['paid_by']) {
                    ...
                    //  $tableRow .= '<td style="padding-left: 70px;"> ' .  ' Deposit Debited by '. strtoupper($rowdata['paid_by']).'</td>';
                    if($rowdata['paid_by']=="deposit" || $rowdata['paid_by']=="supercash")
                    {
                       $tableRow .= '<td style="padding-left: 70px;"> ' .  'Debited by '. strtoupper($rowdata['paid_by']).'</td>';
                    }
                    else
                    {
                        $tableRow .= '<td style="padding-left: 70px;"> ' .  'Deposit Credited by '. strtoupper($rowdata['paid_by']).'</td>';
                    }
                ...
                if ($rowdata['amount'] && $rowdata['super_cash'] > 0) {
                    ...
                    $tableRow .= '<td style="padding-left: 70px;"> ' .' SuperCash Credited by ' . strtoupper($rowdata['paid_by']) . '</td>';
                    $tableRow .= '<td class="text-right"> '. number_format(0,2) .' </td>';
                    $tableRow .= '<td class="text-right"> ' . number_format($credit, 2) . '</td>';
                    $tableRow .= '<td class="text-right"> ' . number_format($Totalbalance, 2) . '</td>';
                    $tableRow .= '</tr>';
...
//                $this->excel->getActiveSheet()->SetCellValue('H' . $row, $Totalbalance);
    ...
    public function getCustomerDepositLedger() {
        ...
        if (isset($_GET['export'])) {
            ...
            if ($this->pos_settings->supercash_amount == 0 && !empty($transactionData)) {
                // echo "hi";
                // exit;
                $biller = $this->site->getCompanyByID($this->pos_settings->default_biller);
              ...
              /*  $this->excel->getActiveSheet()->getStyle("A2:E2")->applyFromArray($style);
               ...
               /* if ($_GET['export'] == 'img') {
            ...
            }else if ($this->pos_settings->supercash_amount == 1 && !empty($transactionData)) {
                ...
                $this->excel->getActiveSheet()->getStyle('F2:H2')->applyFromArray($style1);
                $this->excel->getActiveSheet()->getStyle('F6:T6')->applyFromArray($style2);
                $this->excel->getActiveSheet()->getStyle('F2:F6')->applyFromArray($style3);
                $this->excel->getActiveSheet()->getStyle('H2:H6')->applyFromArray($style4);
                $this->excel->getActiveSheet()->getStyle('K2:K6')->applyFromArray($style4);
                $this->excel->getActiveSheet()->getStyle('N2:N6')->applyFromArray($style4);
                $this->excel->getActiveSheet()->getStyle('T2:T6')->applyFromArray($style4);
                $this->excel->getActiveSheet()->getStyle('Q2:Q6')->applyFromArray($style4);
                $this->excel->getActiveSheet()->getStyle('I2:K2')->applyFromArray($style1);
                $this->excel->getActiveSheet()->getStyle('L2:N2')->applyFromArray($style1);
                $this->excel->getActiveSheet()->getStyle('O2:Q2')->applyFromArray($style1);
                $this->excel->getActiveSheet()->getStyle('R2:T2')->applyFromArray($style1);

                $this->excel->getActiveSheet()->SetCellValue('F2', lang('OPENING AMOUNT'));
                $this->excel->getActiveSheet()->SetCellValue('I2', lang('RECHARGE AMOUNT'));
                $this->excel->getActiveSheet()->SetCellValue('L2', lang('SPENT AMOUNT'));
                $this->excel->getActiveSheet()->SetCellValue('O2', lang('CLOSING AMOUNT'));
                $this->excel->getActiveSheet()->SetCellValue('R2', lang('BALANCE AMOUNT'));
                
                $this->excel->getActiveSheet()->SetCellValue('A3', lang('Date'));
                $this->excel->getActiveSheet()->SetCellValue('B3', lang('Customer Name'));
                $this->excel->getActiveSheet()->SetCellValue('C3', lang('Phone'));
                $this->excel->getActiveSheet()->SetCellValue('D3', lang('Card No.'));
                $this->excel->getActiveSheet()->SetCellValue('E3', lang('Room No'));
                
                $this->excel->getActiveSheet()->SetCellValue('F3', lang('Deposit Opening'));
                $this->excel->getActiveSheet()->SetCellValue('G3', lang('Supercash Opening'));
                $this->excel->getActiveSheet()->SetCellValue('H3', lang('Total Opening Amount'));

                $this->excel->getActiveSheet()->SetCellValue('I3', lang('Deposit Recharge'));
                $this->excel->getActiveSheet()->SetCellValue('J3', lang('Supercash Recharge'));
                $this->excel->getActiveSheet()->SetCellValue('K3', lang('Total Recharge Amount'));

                $this->excel->getActiveSheet()->SetCellValue('L3', lang('Deposit Spend'));
                $this->excel->getActiveSheet()->SetCellValue('M3', lang('Supercash Spend'));
                $this->excel->getActiveSheet()->SetCellValue('N3', lang('Total Spend Amount'));

                $this->excel->getActiveSheet()->SetCellValue('O3', lang('Deposit Closing'));
                $this->excel->getActiveSheet()->SetCellValue('P3', lang('Supercash Closing'));
                $this->excel->getActiveSheet()->SetCellValue('Q3', lang('Total Closing Amount'));

                $this->excel->getActiveSheet()->SetCellValue('R3', lang('Deposit Balance.'));
                $this->excel->getActiveSheet()->SetCellValue('S3', lang('Supercash Balance'));
                $this->excel->getActiveSheet()->SetCellValue('T3', lang('Total Balance Amount'));
                // $this->excel->getActiveSheet()->SetCellValue('U2', lang('Balance Amount'));
                $row = 4;
                $TotalReachange = $TotalSpent = $Totalbalance = 0;
                ...
                foreach ($transactionData as $rowdata) {
                    ...
                    $Total_balance_Amount =    ($rowdata['deposit_closing'])         +  ($rowdata['supercash_closing']); 
                        ...
                        $this->excel->getActiveSheet()->SetCellValue('A' . $row, $rowdata['date']);
                        $this->excel->getActiveSheet()->SetCellValue('B' . $row, $rowdata['Customer_name']);
                        // print_r($transactionData);
                        // exit;
                        $this->excel->getActiveSheet()->SetCellValue('C' . $row, $rowdata['phone']);
                        $this->excel->getActiveSheet()->SetCellValue('D' . $row, $rowdata['card_no']);
                        ...
                        $this->excel->getActiveSheet()->SetCellValue('F' . $row, $rowdata['wallet_deposit_opening']); 
                        $this->excel->getActiveSheet()->SetCellValue('G' . $row, $rowdata['wallet_supercash_opening']); 
                        $this->excel->getActiveSheet()->SetCellValue('H' . $row, $Total_Opening_Amount);

                        $this->excel->getActiveSheet()->SetCellValue('I' . $row, $rowdata['total_deposite_recharge']); 
                        $this->excel->getActiveSheet()->SetCellValue('J' . $row, $rowdata['total_supercash_recharge']); 
                        $this->excel->getActiveSheet()->SetCellValue('K' . $row, $total_recharge);

                        $this->excel->getActiveSheet()->SetCellValue('L' . $row, $rowdata['total_deposite_spend']);
                        $this->excel->getActiveSheet()->SetCellValue('M' . $row, $rowdata['total_supercash_spend']);
                        $this->excel->getActiveSheet()->SetCellValue('N' . $row, $Total_Spend_Amount);

                        $this->excel->getActiveSheet()->SetCellValue('O' . $row, $rowdata['wallet_deposit_closing']);
                        $this->excel->getActiveSheet()->SetCellValue('P' . $row, $rowdata['wallet_supercash_closing']); 
                        $this->excel->getActiveSheet()->SetCellValue('Q' . $row, $Total_Closing_Amount); 

                        $this->excel->getActiveSheet()->SetCellValue('R' . $row, $rowdata['deposit_closing']); 
                        $this->excel->getActiveSheet()->SetCellValue('S' . $row, $rowdata['supercash_closing']); 
                        $this->excel->getActiveSheet()->SetCellValue('T' . $row,  $Total_balance_Amount); 

                        // $this->excel->getActiveSheet()->SetCellValue('U' . $row, $rowdata['balance_amount']); 
                        ...
                        $wallet_deposit_openingA += $rowdata['wallet_deposit_opening'];
                        $wallet_supercash_opening += $rowdata['wallet_supercash_opening'];
                        $Total_Opening_AmountA +=  $Total_Opening_Amount ;

                        $total_deposite_recharge += $rowdata['total_deposite_recharge'];
                        $total_supercash_recharge += $rowdata['total_supercash_recharge'];
                        $total_rechargeA +=  $total_recharge ;

                        $total_deposite_spend += $rowdata['total_deposite_spend'];
                        $total_supercash_spend += $rowdata['total_supercash_spend'];
                        $Total_Spend_AmountA +=  $Total_Spend_Amount;

                        $wallet_deposit_closing += $rowdata['wallet_deposit_closing'];
                        $wallet_supercash_closing += $rowdata['wallet_supercash_closing'];
                        $Total_Closing_AmountA += $Total_Closing_Amount;

                        $deposit_closing += $rowdata['deposit_closing'];
                        $supercash_closing += $rowdata['supercash_closing'];
                        $Total_balance_AmountA += $Total_balance_Amount;
                ...
                $this->excel->getActiveSheet()->SetCellValue('A' . $row, 'Total');
                    ...
                    $this->excel->getActiveSheet()->SetCellValue('F' . $row, $wallet_deposit_openingA);
                    $this->excel->getActiveSheet()->SetCellValue('G' . $row, $wallet_supercash_opening);
                    $this->excel->getActiveSheet()->SetCellValue('H' . $row, $Total_Opening_AmountA);  

                    $this->excel->getActiveSheet()->SetCellValue('I' . $row, $total_deposite_recharge);
                    $this->excel->getActiveSheet()->SetCellValue('J' . $row, $total_supercash_recharge);
                    $this->excel->getActiveSheet()->SetCellValue('K' . $row, $total_rechargeA);

                    $this->excel->getActiveSheet()->SetCellValue('L' . $row, $total_deposite_spend);
                    $this->excel->getActiveSheet()->SetCellValue('M' . $row, $total_supercash_spend);            
                    $this->excel->getActiveSheet()->SetCellValue('N' . $row, $Total_Spend_AmountA);

                    $this->excel->getActiveSheet()->SetCellValue('O' . $row, $wallet_deposit_closing);
                    $this->excel->getActiveSheet()->SetCellValue('P' . $row, $wallet_supercash_closing);
                    $this->excel->getActiveSheet()->SetCellValue('Q' . $row, $Total_Closing_AmountA);

                    $this->excel->getActiveSheet()->SetCellValue('R' . $row, $deposit_closing);            
                    $this->excel->getActiveSheet()->SetCellValue('S' . $row, $supercash_closing);
                    $this->excel->getActiveSheet()->SetCellValue('T' . $row, $Total_balance_AmountA);
            ...
            $tableFooter = '</tbody>
                                ...
                                <tr>                                 
                                    <th colspan="5">Total</th> 
                                    <th class="text-right">' . number_format( $wallet_deposit_openingA,2). '</th> 
                                    <th class="text-right">' . number_format( $wallet_supercash_opening,2). '</th>
                                    <th class="text-right">' . number_format( $Total_Opening_AmountA,2). '</th>

                                    <th class="text-right">' . number_format( $total_deposite_recharge,2). '</th>
                                    <th class="text-right">' . number_format( $total_supercash_recharge,2). '</th>
                                    <th class="text-right">' . number_format( $total_rechargeA,2). '</th>

                                    <th class="text-right">' . number_format( $total_deposite_spend,2). '</th>
                                    <th class="text-right">' . number_format( $total_supercash_spend,2). '</th> 
                                    <th class="text-right">' . number_format( $Total_Spend_AmountA,2). '</th> 

                                    <th class="text-right">' . number_format( $wallet_deposit_closing,2). '</th>
                                    <th class="text-right">' . number_format( $wallet_supercash_closing,2). '</th> 
                                    <th class="text-right">' . number_format( $Total_Closing_AmountA,2). '</th>

                                    <th class="text-right">' . number_format( $deposit_closing,2). ' </th>
                                    <th class="text-right">' . number_format( $supercash_closing,2). '</th> 
                                    <th class="text-right">' . number_format( $Total_balance_AmountA,2). '</th>                                      
                                </tr>
                                </tfoot>
                            </table>';
