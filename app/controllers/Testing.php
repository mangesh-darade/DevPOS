...
//Showing All Tables And Column With Description 
//     public function db()
//     {
...
//                 echo "<br><br>".$arr[$i]."<br>";
//                 echo "---------------<br>";
//                 $fields = $this->db->field_data($arr[$i]);

//                 foreach ($fields as $field)
//                 {
//                    echo $arr[$i]."-".$field->name."<br>";
//                 //    echo $field->type." ";
...
{
        if($this->sma->update_sms_count(1))
        {
                echo "success";
        }
        else
